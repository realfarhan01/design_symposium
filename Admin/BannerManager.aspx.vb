...
Partial Class Admin_BannerManager
        ...
        Try
            ...
            If FUImage.HasFile And BLL.isImage(FUImage.FileContent) Then
                ...
                If FUImage.PostedFile.ContentLength <= 2097152 And FUImage.PostedFile.ContentType.Split("/")(0) = "image" Then
                    ...
                    ResizeImageAndSave(1920, 650, Context.Server.MapPath("../images/banner/origional/" & RandomStr), "../images/banner/" + RandomStr)
                End If
            End If
    ...
    End Sub
    Sub binddata()
        DataDisplay.DataSource = BLL.ExecDataTableProc("GetBanners", "@BannerGroup", 0, "@Deactivated", -1, "@UserName", System.Configuration.ConfigurationManager.AppSettings("UserName"))
