            ...
            <div class="form-horizontal" >
                    ...
                    <div class="panel-body">
                       ...
                       <%-- <div class="alert alert-info fade in widget-inner">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Gallary Category </label>
                            <div class="col-sm-10">
                                <asp:DropDownList ID="ddlCategory" AppendDataBoundItems="true" class="select-search" runat="server" Width="400px" AutoPostBack="True">
                ...
                <div class="table-responsive">
                        ...
                        <Columns>
                         ...
                         <asp:BoundField DataField="GallaryName" HeaderText="Gallary"></asp:BoundField>
                         <asp:BoundField DataField="ImageTag" HeaderText="Image URL"></asp:BoundField>
