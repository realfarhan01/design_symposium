...
Partial Class Admin_gallery
        ...
        Try
            ...
            If FileUpload.HasFile Then
                ...
                If FileUpload.PostedFile.ContentType.Split("/")(0) = "image" Then
                    ...
                    CreateThumbnail(500, Server.MapPath(System.Configuration.ConfigurationManager.AppSettings("gallaryimagepath")) + File, Server.MapPath(System.Configuration.ConfigurationManager.AppSettings("gallarythumbnailpath")) + File)
                End If
            End If
            BLL.AddGallaryImage(File, ddlCategory.SelectedValue, System.Configuration.ConfigurationManager.AppSettings("gallaryimagepath").Replace("~/", ""), System.Configuration.ConfigurationManager.AppSettings("UserName"))
            showdata()
    ...
    Protected Sub DataDisplay_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataDisplay.RowCommand
        ...
        End If
    End Sub
    Sub BindGallaryMaster()
        ddlCategory.DataSource = BLL.ExecDataTable("Select * from tbl_GallaryMaster Where Deactivated=0 and UserName=@UserName", "@UserName", System.Configuration.ConfigurationManager.AppSettings("UserName"))

        ddlCategory.DataTextField = "GallaryName"
        ddlCategory.DataValueField = "GallaryId"
