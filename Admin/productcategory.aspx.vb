...
Partial Class Admin_productcategory
    ...
    Protected Sub btnsubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            ...
            BLL.ExecNonQueryProc("AddUpdate_ProductCategory", "@ProductCategoryId", hfId.Value, "@UserName", user, "@ProductCategory", txtProductCategory.Text, "@ProductCategoryImage", File, "@ShortDesc", "", "@DeActivated", ddlStatus.SelectedValue)
            showdata()
