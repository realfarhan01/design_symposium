...
<!-- Form components -->
            <div class="form-horizontal" >
                ...
                <div class="panel panel-default" id="div1" runat="server">
                    <div class="panel-heading"><h6 class="panel-title">Product Add/Update</h6>
                    <span style="text-align:right;display:block;">
                        <asp:Button ID="btnList" runat="server" Text="Product List" CssClass="btn btn-primary" />
                    </span></div>
                ...
                <div class="panel-heading"><h6 class="panel-title">Product List</h6>
                    <span style="text-align:right;display:block;">
                ...
                <div class="table-responsive">
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                             ...
                             <asp:TemplateField>
                                 <ItemTemplate>
                                     <a href='../images/productcategory/actual/<%#Eval("ImageName") %>' target="_blank" >
                                    <img style="width:150px" alt="" src='../images/productcategory/<%#Eval("ImageName") %>'></img></a>
                                 </ItemTemplate>
                             </asp:TemplateField>
