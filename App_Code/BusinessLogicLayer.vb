...
Public Class BusinessLogicLayer
    ...
    Public Function geospilt(ByVal Number As Integer) As String
        ...
        Return ReturnData
    End Function
    Public Function AddUpdate_Product(ByVal Cnt As Integer, ByVal UserName As String, ByVal ImageName As String, ByVal CategoryId As Integer, ByVal FolderPath As String, ByVal ProductName As String, ByVal ShortDesc As String, ByVal ProductDesc As String, ByVal DeActivated As Integer) As String
