<%@ Page Title="" Language="VB" MasterPageFile="~/web.master" AutoEventWireup="false" CodeFile="project.aspx.vb" Inherits="project" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-12 col-sm-12 col-12 order-lg-1 order-2 banner-column">
                            <div class="banner_content" data-aos="fade-left">
                                <div class="content">
                                    <h1>Our Works</h1>
                                    <p class="text-justify">Our architecture Works encompass a wide range of expertise, from conceptual design to project management and construction administration</p>
                                    <div class="box">
                                        <span class="mb-0">Home</span>
                                        <span class="mb-0 dash">-</span>
                                        <span class="mb-0 box_span">Works</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-12 col-sm-12 col-12 order-lg-2 order-1">
                            <div class="banner_wrapper">
                                <figure class="sub-bannerimage mb-0" data-aos="fade-up">
                                    <img src="assets/images/banner-img-06.png" alt="" class="img-fluid">
                                </figure>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <h2 class="text-center pb-5">Our Works</h2>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="service-box">
                        ...
                        <div class="box-content">
                            ...
                            <a class="read_more text-decoration-none" href="township-urban-planning">Read More <i class="fa-solid fa-chevron-right"></i>
                            </a>
                        </div>
                    </div>
                </div>
